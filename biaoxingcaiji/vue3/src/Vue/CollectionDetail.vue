    ...
    <div class="main-container">
      <div class="app-header">
        <div class="app-logo">
          ...
          <div class="app-logo-text">表型采集</div>
        </div>
        <div class="app-title">{{ collectionTitle }}</div>
        <div class="app-subtitle">实验数据详情</div>
      </div>
          ...
          <div class="upload-section">
            ...
            <div class="upload-area" @click="triggerFileInput" @dragover.prevent @drop="handleDrop">
              <div class="upload-icon">
               ...
               <div class="upload-text">上传实验图像</div>
         ...
         <!-- 图片预览区域 -->
          ...
          <div v-if="uploadedImages.length > 0" class="image-previews">
            ...
            <div class="preview-grid">
              <div v-for="(image, index) in uploadedImages" :key="index" class="preview-item"@click="viewImage(index)">
          ...
          <div class="form-sections">
            ...
            <div class="form-section">
              <div class="section-header">
                <div class="section-title">实验名称</div>
              </div>
              <input type="text" class="form-input large" v-model="collectionForm.name"  placeholder="请输入实验名称">
            </div>
            ...
            <div class="form-section">
              <div class="section-header">
                <div class="section-title">实验位置</div></div>
              <input type="text" class="form-input large" v-model="collectionForm.location" placeholder="请输入实验位置">
            </div>
            <div class="divider"></div>
            ...
            <div class="form-section dual-column">
              ...
              <div class="form-group">
                <div class="section-header">
                  <div class="section-title">实验日期</div>
